...
--checkpoint ./check_point0828/molnet_chirality_cls_etkdg_csp$VARIABLE.pt --device 0"

        python main_chir_kfold.py --config ./configs/molnet_train_l.yaml --k_fold 5 --csp_no $VARIABLE \
                                    --log_dir ./logs/molnet_chirality/ \
                                    --checkpoint ./check_point0828/molnet_chirality_cls_etkdg_csp$VARIABLE-5fold.pt \
                                    --result_path ./results0828/molnet_chirality_cls_etkdg_csp$VARIABLE-5fold.csv \
                                    --device 1
